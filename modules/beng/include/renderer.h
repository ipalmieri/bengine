...
namespace engine
{
   ...
   class renderer
   {
     public:
      ...
      void resetScreen(const int &x, const int &y, const unsigned &width, const unsigned &height);
      
       
      camera *activeCamera() { return _camera; }
      viewport *activeViewport() { return _vport; }
      engnode *rootNode() { return _rootNode; }
