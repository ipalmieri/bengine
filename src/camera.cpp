...
void camera::updateMatrix()
{
  ...
  //Adds Translation
  _matrix[0][3] = -(_position[0]*_matrix[0][0] + _position[1]*_matrix[0][1] +
                    _position[2]*_matrix[0][2]);
  _matrix[1][3] = -(_position[0]*_matrix[1][0] + _position[1]*_matrix[1][1] +
                    _position[2]*_matrix[1][2]);
  _matrix[2][3] = -(_position[0]*_matrix[2][0] + _position[1]*_matrix[2][1] +
                    _position[2]*_matrix[2][2]);
